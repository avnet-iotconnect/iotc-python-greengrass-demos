...
STM32MP157F-DK2.  The solution utilizes the AWS Greengrass nucleus lite. Avnet's /IOTCONNECT platform will also be used 
...
2. Power: Connect the **USB-C cable** from a 5V/2.4A power supply (could be your PC) to the PWR USB-C connector on the board, 
labeled **#2**.
...
<img src="./media/mp157f_create_device.png" width="600">
...
<img src="./media/mp157f_dashboard.png">

## 11. Resources
* Explore connecting the STM32MP157F-DK2 through the Python Lite SDK [QuickStart](https://github.com/avnet-iotconnect/iotc-python-lite-sdk-demos/tree/main/stm32mp157f-dk2)
