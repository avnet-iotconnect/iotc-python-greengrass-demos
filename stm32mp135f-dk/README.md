> [!TIP]
> To connect this device using the /IOTCONNECT Python Lite SDK, refer to this [QuickStart Guide](https://github.com/avnet-iotconnect/iotc-python-lite-sdk-demos/tree/main/stm32mp135f-dk).
