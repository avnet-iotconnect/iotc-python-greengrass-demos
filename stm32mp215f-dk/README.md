> [!TIP]
> To setup and connect this device using the **/IOTCONNECT Python Lite SDK**, refer to this [QuickStart Guide](https://github.com/avnet-iotconnect/iotc-python-lite-sdk-demos/tree/main/stm32mp215f-dk).

# STM32MP215F-DK AWS IoT Greengrass nucleus lite QuickStart
[Purchase the STM32MP215F-DK](https://www.avnet.com/americas/product/stmicroelectronics/stm32mp215f-dk/evolve-151041109/)

<img src="./media/mp215-product.png" width="300" />  
...
STM32MP215F-DK.  The solution utilizes the AWS Greengrass nucleus lite. Avnet's /IOTCONNECT platform will also be used 
...
* 1 USB Type-C Cable (not included in kit)
* MicroSD Card (minimum 8GB, not included in kit)
* Ethernet Cable (not included in kit)
* USB to TTL Serial 3.3V Adapter Cable (not included in kit,
...
3. Enter a custom **Unique ID** and **Device Name** such as `STM32MP215F` (Unique ID and Device Name must match)
> [!IMPORTANT]
...
7. Click **Save & View**
<br><img src="./media/mp215f_create_device.png" width="600"><br>
...
Before continuing, the STM32MP215F-DK requires a Yocto Linux image to be flashed to the
...
4. **Click** *Deploy*
<br><img src="./media/mp215f_deploy.png" width="600"><br>
...
* **Enter** a name (such as `My STM32MP215F Greengrass Dashboard`) and **Click** *Save* to finalize the import

You will now be in the dashboard edit mode. You can add/remove widgets or just click `Save` in the upper-right corner to 
exit the edit mode.

<img src="./media/mp215f_dashboard.png">

## 11. Resources
* Explore connecting the STM32MP215F-DK through the Python Lite SDK [QuickStart](https://github.com/avnet-iotconnect/iotc-python-lite-sdk-demos/tree/main/stm32mp215f-dk)
